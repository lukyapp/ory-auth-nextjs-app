...
describe('handleContinueWith', () => {
  ...
  it('should handle show_verification_ui action with URL correctly', () => {
    ...
    expect(result).toBe(true);
    expect(onRedirectMock).toHaveBeenCalledWith('https://example.com/verification', true);
  });
  ...
  it('should handle show_verification_ui action without URL correctly', () => {
    ...
    expect(result).toBe(true);
    expect(onRedirectMock).toHaveBeenCalledWith('/verification?flow=test-flow-id', false);
  });
  ...
  it('should handle show_recovery_ui action correctly', () => {
    ...
    expect(result).toBe(true);
    expect(onRedirectMock).toHaveBeenCalledWith('/recovery?flow=test-flow-id', false);
  });
  ...
  it('should handle show_settings_ui action correctly', () => {
    ...
    expect(result).toBe(true);
    expect(onRedirectMock).toHaveBeenCalledWith('/settings?flow=test-flow-id', false);
  });
  ...
  it('should pick the highest priority action', () => {
    ...
    expect(onRedirectMock).toHaveBeenCalledWith('/settings?flow=settings-id', false);
  });
});
