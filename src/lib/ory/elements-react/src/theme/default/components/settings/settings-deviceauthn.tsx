    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="flex flex-col gap-4">
        {removeButtons.map((node, i) => {
          ...
          const createdAt = 'created_at' in context ? (context.created_at as string) : null;
          const deviceName = 'device_name' in context ? (context.device_name as string) : null;
          const deviceType = 'device_type' in context ? (context.device_type as string) : null;
