...
test('should describe the code method as SMS with a phone icon for an sms address', () => {
  ...
  expect(screen.getByText('A verification code will be sent to your phone')).toBeInTheDocument();
...
test('should keep the email wording and icon for an email address', () => {
  ...
  expect(screen.getByText('A verification code will be sent to your email')).toBeInTheDocument();
