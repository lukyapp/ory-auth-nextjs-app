...
export function DefaultCurrentIdentifierButton() {
  ...
  if (flowType === FlowType.Login && (flow.requested_aal === 'aal2' || flow.refresh)) {
    ...
    return (
      <span
        className={
          'rounded-identifier border-button-identifier-border-border-default bg-button-identifier-background-default inline-flex max-w-full items-center gap-1 self-start border px-[11px] py-[5px]'
        }
      ...
      >
        <span className="inline-flex min-h-5 items-center gap-2 overflow-hidden text-ellipsis">
          <span className="text-button-identifier-foreground-default overflow-hidden text-sm font-medium text-nowrap text-ellipsis">
            {identifier}
          </span>
        </span>
      </span>
  ...
  if (screenSelectionNode) {
    ...
    return (
      <form action={flow.ui.action} method={flow.ui.method}>
        ...
        <button
          className={
            'group rounded-identifier border-button-identifier-border-border-default bg-button-identifier-background-default hover:border-button-identifier-border-border-hover hover:bg-button-identifier-background-hover inline-flex max-w-full cursor-pointer items-center gap-1 self-start border px-[11px] py-[5px] transition-colors'
          }
        ...
        >
          <span className="inline-flex min-h-5 items-center gap-2 overflow-hidden text-ellipsis">
            <IconArrowLeft
              size={16}
              stroke="1"
              className="text-button-identifier-foreground-default group-hover:text-button-identifier-foreground-hover shrink-0"
            />
            <span className="text-button-identifier-foreground-default group-hover:text-button-identifier-foreground-hover overflow-hidden text-sm font-medium text-nowrap text-ellipsis">
