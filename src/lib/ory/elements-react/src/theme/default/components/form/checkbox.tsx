...
function CheckboxSVG() {
  return (
    <svg
      className="fill-checkbox-foreground-checked absolute hidden size-4 peer-checked:block"
    ...
    <label className="flex cursor-pointer items-start gap-3 self-stretch antialiased">
      <span className="flex h-5 items-center">
        <input
          {...inputProps}
          className={cn(
            'peer rounded-forms border-checkbox-border-checkbox-border-default bg-checkbox-background-default checked:border-checkbox-border-checkbox-border-checked checked:bg-checkbox-background-checked size-4 appearance-none border',
      ...
      <span className="flex flex-col">
        <span className="text-interface-foreground-default-primary leading-tight font-normal">
