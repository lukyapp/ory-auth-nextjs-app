...
test('Text nodes are translated to german', () => {
  ...
  expect(screen.getByTestId('ory/form/node/input/totp_secret_key')).toBeVisible();
  expect(screen.getByTestId('ory/form/node/input/totp_secret_key')).toHaveValue('XXXXXX');
});
