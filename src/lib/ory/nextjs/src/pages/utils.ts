...
export const toBrowserEndpointRedirect = (params: URLSearchParams, flowType: FlowType) =>
...
export const handleRestartFlow = (searchParams: URLSearchParams, flowType: FlowType) => () => {
