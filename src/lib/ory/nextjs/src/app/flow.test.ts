...
import { AccountExperienceConfiguration, FlowType, handleFlowError } from '@ory/client-fetch';
import { redirect } from 'next/navigation';
import { getLoginFlow, getRecoveryFlow, getRegistrationFlow, getVerificationFlow } from '.';
...
jest.mock('./utils', () => ({
  ...
  toGetFlowParameter: jest.fn().mockImplementation((params: QueryParams) => params),
}));
